...
export default function CuentaCorrienteDetalle() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h2 className="text-2xl font-semibold text-center mb-6">Cuenta Corriente Detallada</h2>
      ...
      {detalle.length === 0 ? (
        ...
        detalle.map(({ mes, saldo, movimientos }) => (
          <div
            key={mes}
            className="bg-white shadow-md rounded-xl border border-gray-200 mb-6 p-4"
          >
            {/* Encabezado del mes */}
            ...
            {movimientos.length === 0 ? (
              ...
              movimientos.map((mov, index) => (
                ...
                >
                  <div className="text-sm text-gray-700">{mov.descripcion}</div>
                  <div
